...
function Register() {
    ...
    function sendData(e){
        e.preventDefault();
        axios.post('http://localhost:80/platform/react_project/register.php/' , input).then(function(response){
                            ...
                            <div className="card-body px-4 py-5 px-md-5">
                                ...
                                <div className="row">
                                    ...
                                    <div className="form-outline">
                                        ...
                                        <input type="text" id="firstName" onChange={handleChange} name="first_name" className="form-control" />
                                    </div>
                                    <div id="username-warining" style={{display: 'none' , color:'red' , fontSize : '15px'}}>Please don't use numbers or Char. And don't let it empty.</div>
                                    <div id="username-accept" style={{display: 'none' , color:'green' , fontSize : '15px'}}>Username is okay.</div>
                                    </div>
                                    <div className="col-md-6 mb-4">
                                    <div className="form-outline">
                                        <label className="form-label" htmlFor="form3Example2">Last name</label>
                                        <input type="text" id="lastName"  onChange={handleChange} name="last_name" className="form-control" />
                                        <div id="last-warining" style={{display: 'none' , color:'red' , fontSize : '15px'}}>Please don't use numbers or Char. And don't let it empty.</div>
                                        <div id="last-accept" style={{display: 'none' , color:'green' , fontSize : '15px'}}>Username is okay.</div>
                                    </div>
                                    </div>
                                </div>
                                <div className="form-outline mb-4">
                                    <label className="form-label" htmlFor="form3Example3">Email address</label>
                                    <input type="email" id="email" onChange={handleEmail} name="email" className="form-control" />
                                    <p id="warning" style={{color : "red" , display : "none"}}>Invalid Email</p>
                                    <div id="email-repeat" style={{color : "red" , display : "none"}}>Your email is repeated.Please use another one.</div>
                                </div>
                                <div className="form-outline mb-4">
                                    <label className="form-label" htmlFor="form3Example4">Password</label>
                                    <input type="password" id="password" onBlur={handlePass} className="form-control" />
                                    <div id="password-warining" style={{display: 'none' , color:'red' , fontSize : '15px'}}>Please use capital and small letters, numbers and special Char in your password.</div>
                                    <div id="password-accept" style={{display: 'none' , color:'green' , fontSize : '15px'}}>Password is okay.</div>
                                </div>
                                <div className="form-outline mb-4">
                                    <label className="form-label" htmlFor="form3Example4">Confirm Password</label>
                                    <input type="password" id="confirmPassword" onBlur={handleConfirmPass} name="password" className="form-control" />
                                    <div id="repassword-warining" style={{display: 'none' , color:'red' , fontSize : '15px'}}>Your password does not match.</div>
                                    <div id="repassword-accept" style={{display: 'none' , color:'green' , fontSize : '15px'}}>Password Matched.</div>
                                </div>
